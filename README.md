...
4. Pegar la API Key personal de The Movie Database (TMDB) en la variable 'theMovieDbApiKey' de la constante 'environment' presente en el archivo src/app/environment.ts.
